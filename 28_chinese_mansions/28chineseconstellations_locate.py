...
minute = 0
second = 0
jd = Time(f"{year}-{month}-{day} {hour}:{minute}:{second}", scale='utc').jd
observe_time= Time(jd, format='jd')
observe_location = EarthLocation(lat=51.500000*u.deg, lon=-0.170000*u.deg, height=500*u.m)
