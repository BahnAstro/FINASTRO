...
readdata1 = pd.read_csv("/Users/jacky/x/daily_high_low_2006_v3_1.csv", header=None, skiprows=1, names=['DateTime', 'Open', 'High', 'Low', 'Close', 'HL'], encoding='ISO-8859-1')
...
export_all_data.to_csv("/Users/x/Desktop/PLANET_ALLDATA_HSI.csv", index=False)
